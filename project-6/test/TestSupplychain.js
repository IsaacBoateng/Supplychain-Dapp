...
it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
    ...
    var farmerPreBalance = await web3.eth.getBalance(originFarmerID);
    await supplyChain.buyItem(upc, { from: distributorID, value: productPrice.toString() });
    var farmerPostBalance = await web3.eth.getBalance(originFarmerID);
    var finalFarmerBalance = Number(farmerPostBalance) - Number(farmerPreBalance);
